...
object DummyData {
    ...
    private fun villageSetting(dummyCharaId: Int): VillageSettings =
        VillageSettings(
    ...
    private fun villageTime(): VillageTime =
        VillageTime(
    ...
    private fun prologueVillageDay(): VillageDay =
        VillageDay(
            id = randomInt(),
            day = 1,
    ...
    fun villageParticipant(): VillageParticipant =
        VillageParticipant(
            id = randomInt(),
            chara = chara(),
            player = player(),
    ...
    fun charaName(): CharaName =
        CharaName(
            name = "dummy",
            shortName = "d",
        )

    fun charaImage(): CharaImage =
        CharaImage(
            width = 50,
            height = 77,
            imageUrl = "dummy",
