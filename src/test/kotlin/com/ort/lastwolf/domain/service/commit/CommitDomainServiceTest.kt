package com.ort.lastwolf.domain.service.commit
...
@SpringBootTest
class CommitDomainServiceTest : LastwolfTest() {

    @Autowired
    lateinit var commitDomainService: CommitDomainService
    ...
    fun test_isAvailableCommit_コミット不可設定() {
        ...
        // ## Act ##
        val isAvailableCommit = commitDomainService.isAvailableCommit(village, participant)
