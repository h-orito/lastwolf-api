...
@SpringBootTest
class SkillRequestDomainServiceTest : FirewolfTest() {

    @Autowired
    lateinit var skillRequestDomainService: SkillRequestDomainService
    ...
    fun test_isAvailableSkillRequest_参加していない() {
        ...
        // ## Act ##
        val isAvailableSkillRequest = skillRequestDomainService.isAvailableSkillRequest(village, participant)
