...
@SpringBootTest
class EpilogueDomainServiceTest : FirewolfTest() {

    @Autowired
    lateinit var epilogueDomainService: EpilogueDomainService
    ...
    fun test_transitionToEpilogueIfNeeded_狼勝利() {
        ...
        // ## Act ##
        val afterDayChange = epilogueDomainService.transitionToEpilogueIfNeeded(dayChange)
    ...
    fun test_addDayIfNeeded_必要なし() {
        ...
        // ## Act ##
        val afterDayChange = epilogueDomainService.addDayIfNeeded(dayChange)
    ...
    fun test_dayChange() {
        ...
        // ## Act ##
        val afterDayChange = epilogueDomainService.dayChange(dayChange)
