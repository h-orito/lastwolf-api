...
@SpringBootTest
@Transactional
class AbilityDataSourceTest : FirewolfTest() {
    ...
    fun test_updateAbility() {
        ...
        val villageAbility = VillageAbility(
            ...
            abilityType = com.ort.firewolf.domain.model.ability.AbilityType(CDef.AbilityType.襲撃)
        )
    ...
    fun test_updateDifference() {
        ...
        val after = before.copy(
            list = before.list + VillageAbility(
                ...
                myselfId = villagePlayerId2,
                targetId = villagePlayerId,
                abilityType = com.ort.firewolf.domain.model.ability.AbilityType(CDef.AbilityType.占い)
            )
        )
