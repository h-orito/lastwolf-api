...
object VillageDataConverter {
    ...
    fun convertVillageToVillage(village: Village): com.ort.lastwolf.domain.model.village.Village {
        ...
        return com.ort.lastwolf.domain.model.village.Village(
            ...
            winCamp =
                village.winCampCodeAsCamp?.let {
                    com.ort.lastwolf.domain.model.camp
                        .Camp(it)
                },
        )
    }
    ...
    private fun convertToChara(chara: Chara): com.ort.lastwolf.domain.model.charachip.Chara =
        com.ort.lastwolf.domain.model.charachip.Chara(
            id = chara.charaId,
            name =
                CharaName(
    ...
    private fun convertToDeadReasonToDead(vp: VillagePlayer): Dead =
        Dead(vp.deadReasonCodeAsDeadReason, convertVillageDayToVillageDay(vp.villageDay.get()))

    private fun detectItemText(
        settingList: List<VillageSetting>,
        item: CDef.VillageSettingItem,
    ): String? = settingList.find { setting -> setting.villageSettingItemCodeAsVillageSettingItem == item }?.villageSettingText
}
