...
import com.ort.lastwolf.domain.service.ability.AutopsyDomainService
import com.ort.lastwolf.domain.service.ability.BakeryDomainService
import com.ort.lastwolf.domain.service.ability.DivineDomainService
import com.ort.lastwolf.domain.service.ability.GuardDomainService
import com.ort.lastwolf.domain.service.ability.GuruDomainService
import com.ort.lastwolf.domain.service.ability.PsychicDomainService
import com.ort.lastwolf.domain.service.ability.WiseDivineDomainService
...
class ProgressDomainService(
    ...
    private fun shouldForward(village: Village, commits: Commits): Boolean {
        ...
        // 更新日時を過ぎている
        return !LastwolfDateUtil.currentLocalDateTime().isBefore(village.day.latestDay().dayChangeDatetime)
    }
