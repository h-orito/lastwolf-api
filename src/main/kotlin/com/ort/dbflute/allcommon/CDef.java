...
public interface CDef extends Classification {
    ...
    public enum VillageStatus implements CDef {
         ...
         */
        public boolean isSolvedVillage() { return 決着.equals(this) || 廃村.equals(this) || 終了.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 終了した村 <br>
        ...
        public static List<VillageStatus> listOfSolvedVillage() {
            return new ArrayList<>(Arrays.asList(決着, 廃村, 終了));
        }
        /**
         * Get the list of group classification elements. (returns new copied list) <br>
         * 終了した村 <br>
    ...
    public enum Skill implements CDef {
         ...
         * @return The determination, true or false.
         */
        public boolean isViewableMasonSay() { return 共有者.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 共有発言可能 <br>
         * The group elements:[共有者]
         * @return The determination, true or false.
         */
        public boolean isAvailableMasonSay() { return 共有者.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 襲撃対象に選べない <br>
         ...
         * @return The determination, true or false.
         */
        public boolean isRecognizableEachFox() { return 妖狐.equals(this) || 背徳者.equals(this); }
        /**
         * Is the classification in the group? <br>
         * 襲撃耐性を持つ <br>
         * The group elements:[妖狐]
        ...
        public boolean inGroup(String groupName) {
            ...
            if ("viewableMasonSay".equalsIgnoreCase(groupName)) { return isViewableMasonSay(); }
            if ("availableMasonSay".equalsIgnoreCase(groupName)) { return isAvailableMasonSay(); }
            ...
            if ("recognizableEachFox".equalsIgnoreCase(groupName)) { return isRecognizableEachFox(); }
         ...
         * @return The snapshot list of classification elements in the group. (NotNull)
         */
        public static List<Skill> listOfRecognizableEachFox() {
    ...
    public enum MessageType implements CDef {
        ...
        /** 個別能力行使結果 */
        個別能力行使結果("PRIVATE_ABILITY", "個別能力行使結果"),
        /** 狂信者人狼確認メッセージ */
    ...
    public enum VillageSettingItem implements CDef {
        ...
        /** 沈黙時間 */
        沈黙時間("silent_seconds", "沈黙時間"),
        /** 開始予定日時 */
        開始予定日時("start_datetime", "開始予定日時"),
        /** 投票時間秒 */
        投票時間秒("vote_seconds", "投票時間秒");
    ...
    public enum Noonnight implements CDef {
        ...
        昼("NOON", "昼"),
        /** 投票1回目 */
        投票1回目("VOTE_FIRST", "投票1回目"),
        /** 投票2回目 */
        投票2回目("VOTE_SECOND", "投票2回目"),
        /** 投票3回目 */
        投票3回目("VOTE_THIRD", "投票3回目");
    ...
    public enum WinLose implements CDef {
        ...
        /** 勝利 */
        勝利("WIN", "勝利");
        private static ZzzoneSlimmer<WinLose> _slimmer = new ZzzoneSlimmer<>(WinLose.class, values());
        private static final Map<String, Map<String, Object>> _subItemMapMap = new HashMap<String, Map<String, Object>>();
        static {
            {
                Map<String, Object> subItemMap = new HashMap<String, Object>();
        ...
        private String _code; private String _alias;
        private WinLose(String code, String alias) { _code = code; _alias = alias; }
        public String code() { return _code; } public String alias() { return _alias; }
        public Set<String> sisterSet() { return Collections.emptySet(); }
        public Map<String, Object> subItemMap() { return _subItemMapMap.get(code()); }
         ...
         * @return The optional classification corresponding to the code. (NotNull, EmptyAllowed: if not found, returns empty)
         */
        public static OptionalThing<WinLose> of(Object code) { return _slimmer.of(code); }
        /**
         * Find the classification by the name. (CaseInsensitive)
         * @param name The string of name, which is case-insensitive. (NotNull)
         * @return The optional classification corresponding to the name. (NotNull, EmptyAllowed: if not found, returns empty)
         */
        public static OptionalThing<WinLose> byName(String name) { return _slimmer.byName(name); }
        /**
         * <span style="color: #AD4747; font-size: 120%">Old style so use of(code).</span>
         * @param code The value of code, which is case-insensitive. (NullAllowed: if null, returns null)
         * @return The instance of the corresponding classification to the code. (NullAllowed: if not found, returns null)
         */
        public static WinLose codeOf(Object code) { return _slimmer.codeOf(code); }
        /**
         * <span style="color: #AD4747; font-size: 120%">Old style so use byName(name).</span>
         * @param name The string of name, which is case-sensitive. (NullAllowed: if null, returns null)
         * @return The instance of the corresponding classification to the name. (NullAllowed: if not found, returns null)
         ...
         */
        @Deprecated
        public static WinLose nameOf(String name) { return _slimmer.nameOf(name, nm -> valueOf(nm)); }
        /**
         * Get the list of all classification elements. (returns new copied list)
         * @return The snapshot list of all classification elements. (NotNull)
         */
        public static List<WinLose> listAll() { return _slimmer.listAll(values()); }
        /**
         * Get the list of classification elements in the specified group. (returns new copied list)
         * @param groupName The string of group name, which is case-insensitive. (NotNull)
         * @return The snapshot list of classification elements in the group. (NotNull)
         ...
         */
        @Deprecated
        public static List<WinLose> listOf(Collection<String> codeList) { return _slimmer.listOf(codeList); }
        /**
         * <span style="color: #AD4747; font-size: 120%">Old style so use listByGroup(groupName).</span>
         * @param groupName The string of group name, which is case-sensitive. (NullAllowed: if null, returns empty list)
         * @return The snapshot list of classification elements in the group. (NotNull, EmptyAllowed: if the group is not found)
         ...
         */
        @Deprecated
        public static List<WinLose> groupOf(String groupName) { return new ArrayList<>(); }
        @Override public String toString() { return code(); }
    }
    ...
    public enum DefMeta implements ClassificationMeta {
        ...
        /** 勝敗 */
        WinLose(cd -> CDef.WinLose.of(cd), nm -> CDef.WinLose.byName(nm)
        , () -> CDef.WinLose.listAll(), gp -> CDef.WinLose.listByGroup(gp)
        , ClassificationCodeType.String, ClassificationUndefinedHandlingType.LOGGING);
