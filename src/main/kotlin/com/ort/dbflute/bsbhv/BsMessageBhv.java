...
/**
 * The behavior of MESSAGE as TABLE.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsMessageBhv extends AbstractBehaviorWritable<Message, MessageCB> {
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public MessageCB newConditionBean() { return new MessageCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of Message. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<MessageCB> cbLambda) {
     ...
     */
    public OptionalEntity<Message> selectEntity(CBCall<MessageCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<Message> facadeSelectEntity(MessageCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends Message> OptionalEntity<ENTITY> doSelectOptionalEntity(MessageCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * Message <span style="color: #553000">message</span> = <span style="color: #0000C0">messageBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Message selectEntityWithDeletedCheck(CBCall<MessageCB> cbLambda) {
     ...
     * <pre>
     * ListResultBean&lt;Message&gt; <span style="color: #553000">messageList</span> = <span style="color: #0000C0">messageBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (Message <span style="color: #553000">message</span> : <span style="color: #553000">messageList</span>) {
     *     ... = <span style="color: #553000">message</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of Message. (NotNull)
     ...
     */
    public ListResultBean<Message> selectList(CBCall<MessageCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;Message&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">messageBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (Message message : <span style="color: #553000">page</span>) {
     *     ... = message.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of Message. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<Message> selectPage(CBCall<MessageCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of Message. (NotNull)
     * @param entityLambda The handler of entity row of Message. (NotNull)
     */
    public void selectCursor(CBCall<MessageCB> cbLambda, EntityRowHandler<Message> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<MessageCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<Message> messageList, ReferrerLoaderHandler<LoaderOfMessage> loaderLambda) {
        xassLRArg(messageList, loaderLambda);
        loaderLambda.handle(new LoaderOfMessage().ready(messageList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(Message message, ReferrerLoaderHandler<LoaderOfMessage> loaderLambda) {
     ...
     * <pre>
     * Message message = <span style="color: #70226C">new</span> Message();
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<Message> messageList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<Message> messageList) {
     ...
     * <pre>
     * <span style="color: #0000C0">messageBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;Message, MessageCB&gt;() {
     *     public ConditionBean setup(Message entity, MessageCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<Message, MessageCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(Message message, CBCall<MessageCB> cbLambda) {
     ...
     * <pre>
     * <span style="color: #0000C0">messageBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of Message. (NotNull)
     ...
     */
    public int queryDelete(CBCall<MessageCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(Message message, WritableOptionCall<MessageCB, InsertOption<MessageCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(Message message, WritableOptionCall<MessageCB, UpdateOption<MessageCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(Message message, WritableOptionCall<MessageCB, InsertOption<MessageCB>> insertOpLambda, WritableOptionCall<MessageCB, UpdateOption<MessageCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(Message message, WritableOptionCall<MessageCB, DeleteOption<MessageCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<Message> messageList, WritableOptionCall<MessageCB, InsertOption<MessageCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<Message> messageList, WritableOptionCall<MessageCB, UpdateOption<MessageCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<Message> messageList, WritableOptionCall<MessageCB, DeleteOption<MessageCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<Message, MessageCB> manyArgLambda, WritableOptionCall<MessageCB, InsertOption<MessageCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(Message message, CBCall<MessageCB> cbLambda, WritableOptionCall<MessageCB, UpdateOption<MessageCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<MessageCB> cbLambda, WritableOptionCall<MessageCB, DeleteOption<MessageCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<MessageBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends Message> typeOfSelectedEntity() { return Message.class; }
    protected Class<Message> typeOfHandlingEntity() { return Message.class; }
    protected Class<MessageCB> typeOfHandlingConditionBean() { return MessageCB.class; }
