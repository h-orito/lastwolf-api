...
public abstract class AbstractBsWinloseCQ extends AbstractConditionQuery {
    ...
    public void existsVillagePlayer(SubQuery<VillagePlayerCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepWinloseCode_ExistsReferrer_VillagePlayerList(cb.query());
        registerExistsReferrer(cb.query(), "WINLOSE_CODE", "WINLOSE_CODE", pp, "villagePlayerList");
    }
    public abstract String keepWinloseCode_ExistsReferrer_VillagePlayerList(VillagePlayerCQ sq);
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of WinloseCode_NotExistsReferrer_VillagePlayerList for 'not exists'. (NotNull)
     */
    public void notExistsVillagePlayer(SubQuery<VillagePlayerCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        VillagePlayerCB cb = new VillagePlayerCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepWinloseCode_NotExistsReferrer_VillagePlayerList(cb.query());
        registerNotExistsReferrer(cb.query(), "WINLOSE_CODE", "WINLOSE_CODE", pp, "villagePlayerList");
    }
    public abstract String keepWinloseCode_NotExistsReferrer_VillagePlayerList(VillagePlayerCQ sq);
    ...
    public void xsderiveVillagePlayerList(String fn, SubQuery<VillagePlayerCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepWinloseCode_SpecifyDerivedReferrer_VillagePlayerList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "WINLOSE_CODE", "WINLOSE_CODE", pp, "villagePlayerList", al, op);
    }
    public abstract String keepWinloseCode_SpecifyDerivedReferrer_VillagePlayerList(VillagePlayerCQ sq);
    ...
    public void xqderiveVillagePlayerList(String fn, SubQuery<VillagePlayerCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        VillagePlayerCB cb = new VillagePlayerCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepWinloseCode_QueryDerivedReferrer_VillagePlayerList(cb.query()); String prpp = keepWinloseCode_QueryDerivedReferrer_VillagePlayerListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "WINLOSE_CODE", "WINLOSE_CODE", sqpp, "villagePlayerList", rd, vl, prpp, op);
    }
    public abstract String keepWinloseCode_QueryDerivedReferrer_VillagePlayerList(VillagePlayerCQ sq);
    public abstract String keepWinloseCode_QueryDerivedReferrer_VillagePlayerListParameter(Object vl);
     ...
     * WINLOSE_NAME: {NotNull, VARCHAR(20)} <br>
