...
public abstract class AbstractBsVillagePlayerCQ extends AbstractConditionQuery {
     ...
     */
    public void setSkillCode_InScope_RecognizableEachFox() {
        setSkillCode_InScope_AsSkill(CDef.Skill.listOfRecognizableEachFox());
    }
     ...
     * The group elements:[妖狐, 背徳者]
     */
    public void setRequestSkillCode_InScope_RecognizableEachFox() {
        setRequestSkillCode_InScope_AsSkill(CDef.Skill.listOfRecognizableEachFox());
    }
     ...
     * The group elements:[妖狐, 背徳者]
     */
    public void setSecondRequestSkillCode_InScope_RecognizableEachFox() {
        setSecondRequestSkillCode_InScope_AsSkill(CDef.Skill.listOfRecognizableEachFox());
    }
     ...
     * @param doneRollcall The value of doneRollcall as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setDoneRollcall_Equal(Boolean doneRollcall) {
        regDoneRollcall(CK_EQ, doneRollcall);
    }

    protected void regDoneRollcall(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueDoneRollcall(), "DONE_ROLLCALL"); }
    protected abstract ConditionValue xgetCValueDoneRollcall();
