...
public class BsWinloseCQ extends AbstractBsWinloseCQ {
    ...
    public Map<String, VillagePlayerCQ> xdfgetWinloseCode_ExistsReferrer_VillagePlayerList() { return xgetSQueMap("winloseCode_ExistsReferrer_VillagePlayerList"); }
    public String keepWinloseCode_ExistsReferrer_VillagePlayerList(VillagePlayerCQ sq) { return xkeepSQue("winloseCode_ExistsReferrer_VillagePlayerList", sq); }

    public Map<String, VillagePlayerCQ> xdfgetWinloseCode_NotExistsReferrer_VillagePlayerList() { return xgetSQueMap("winloseCode_NotExistsReferrer_VillagePlayerList"); }
    public String keepWinloseCode_NotExistsReferrer_VillagePlayerList(VillagePlayerCQ sq) { return xkeepSQue("winloseCode_NotExistsReferrer_VillagePlayerList", sq); }

    public Map<String, VillagePlayerCQ> xdfgetWinloseCode_SpecifyDerivedReferrer_VillagePlayerList() { return xgetSQueMap("winloseCode_SpecifyDerivedReferrer_VillagePlayerList"); }
    public String keepWinloseCode_SpecifyDerivedReferrer_VillagePlayerList(VillagePlayerCQ sq) { return xkeepSQue("winloseCode_SpecifyDerivedReferrer_VillagePlayerList", sq); }

    public Map<String, VillagePlayerCQ> xdfgetWinloseCode_QueryDerivedReferrer_VillagePlayerList() { return xgetSQueMap("winloseCode_QueryDerivedReferrer_VillagePlayerList"); }
    public String keepWinloseCode_QueryDerivedReferrer_VillagePlayerList(VillagePlayerCQ sq) { return xkeepSQue("winloseCode_QueryDerivedReferrer_VillagePlayerList", sq); }
    public Map<String, Object> xdfgetWinloseCode_QueryDerivedReferrer_VillagePlayerListParameter() { return xgetSQuePmMap("winloseCode_QueryDerivedReferrer_VillagePlayerList"); }
    public String keepWinloseCode_QueryDerivedReferrer_VillagePlayerListParameter(Object pm) { return xkeepSQuePm("winloseCode_QueryDerivedReferrer_VillagePlayerList", pm); }
     ...
     * @return this. (NotNull)
     */
    public BsWinloseCQ addOrderBy_DispOrder_Asc() { regOBA("DISP_ORDER"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsWinloseCQ addOrderBy_DispOrder_Desc() { regOBD("DISP_ORDER"); return this; }
