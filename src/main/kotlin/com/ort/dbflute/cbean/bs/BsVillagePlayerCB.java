...
public class BsVillagePlayerCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<VillagePlayerCQ> {
         ...
         * }, ComingOut.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<ComingOutCB, VillagePlayerCQ> derivedComingOut() {
            assertDerived("comingOutList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ComingOutCB> sq, VillagePlayerCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveComingOutList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
