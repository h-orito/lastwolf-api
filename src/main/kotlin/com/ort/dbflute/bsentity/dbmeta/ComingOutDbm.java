...
public class ComingOutDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignSkill() {
        ...
        return cfi("FK_COMMING_OUT_SKILL", "skill", this, SkillDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "comingOutList", false);
    }
    /**
    ...
    public ForeignInfo foreignVillagePlayer() {
        ...
        return cfi("FK_COMMING_OUT_VILLAGE_PLAYER", "villagePlayer", this, VillagePlayerDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "comingOutList", false);
    }
