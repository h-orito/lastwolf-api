...
public class WinloseDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((Winlose)et).getDispOrder(), (et, vl) -> ((Winlose)et).setDispOrder(cti(vl)), "dispOrder");
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnWinloseCode = cci("WINLOSE_CODE", "WINLOSE_CODE", null, null, String.class, "winloseCode", null, true, false, true, "VARCHAR", 20, 0, null, null, false, null, null, null, "villagePlayerList", CDef.DefMeta.WinLose, false);
    protected final ColumnInfo _columnWinloseName = cci("WINLOSE_NAME", "WINLOSE_NAME", null, null, String.class, "winloseName", null, false, false, true, "VARCHAR", 20, 0, null, null, false, null, null, null, null, null, false);
    ...
    public ReferrerInfo referrerVillagePlayerList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnWinloseCode(), VillagePlayerDbm.getInstance().columnWinloseCode());
        return cri("FK_VILLAGE_PLAYER_WINLOSE", "villagePlayerList", this, VillagePlayerDbm.getInstance(), mp, false, "winlose");
    }
