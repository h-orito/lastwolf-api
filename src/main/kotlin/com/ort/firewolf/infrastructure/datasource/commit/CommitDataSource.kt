package com.ort.firewolf.infrastructure.datasource.commit
...
class CommitDataSource(
     ...
     * @param commit commit
     */
    fun updateCommit(commit: com.ort.firewolf.domain.model.commit.Commit) {
        deleteCommit(commit)
        if (commit.isCommitting) insertCommit(commit)
    }

    private fun deleteCommit(commit: com.ort.firewolf.domain.model.commit.Commit) {
    ...
    private fun insertCommit(c: com.ort.firewolf.domain.model.commit.Commit) {
        val commit = Commit()
